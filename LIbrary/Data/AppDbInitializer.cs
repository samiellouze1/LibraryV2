        ...
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Book.Any())
                {
                    ...
                    {
                        //lezem tzid rating
                        new Book(){ Id="1",coverUrl=cover1,title = "Foundation", description = "A series of novels set in a future where mathematician Hari Seldon develops a theory of psychohistory to predict the future of human civilization.", dateOfCreation = DateTime.Today, price = 10, author=firstAuthor ,genre= firstGenre},
                        new Book(){ Id="2",coverUrl=cover2,title = "I, Robot", description = "A collection of interconnected short stories exploring the relationships between humans and robots, and the ethical implications of artificial intelligence.", dateOfCreation = DateTime.Today, price = 20, author=firstAuthor ,genre= secondGenre},
                        new Book(){ Id="3",coverUrl=cover3,title = "The Caves of Steel", description = "A science fiction mystery novel featuring detective Elijah Baley and his robot partner, R. Daneel Olivaw, as they investigate a murder on a futuristic Earth.", dateOfCreation = DateTime.Today, price = 30, author=firstAuthor ,genre= thirdGenre},
                        new Book(){ Id="4",coverUrl=cover4,title = "Murder on the Orient Express", description = "One of Christie's most famous novels, featuring the brilliant Belgian detective Hercule Poirot solving a murder mystery aboard the luxurious Orient Express train.", dateOfCreation = DateTime.Today, price = 10, author=secondAuthor ,genre= firstGenre},
                        new Book(){ Id="5",coverUrl=cover5,title = "And Then There Were None", description = "A classic mystery novel where ten strangers are invited to a remote island and are mysteriously killed off one by one, with the remaining guests trying to uncover the identity of the murderer.", dateOfCreation = DateTime.Today, price = 20, author=secondAuthor ,genre= secondGenre},
                        new Book(){ Id="6",coverUrl=cover6,title = "The Murder of Roger Ackroyd", description = "A groundbreaking mystery novel known for its clever twist ending, featuring amateur detective Hercule Poirot investigating the murder of a wealthy man in a small English village.", dateOfCreation = DateTime.Today, price = 40, author=secondAuthor ,genre= thirdGenre},
                        new Book(){ Id="7",coverUrl=cover7,title = "The Hobbit", description = "A beloved fantasy novel following the adventures of Bilbo Baggins, a hobbit who embarks on a quest with a group of dwarves and the wizard Gandalf to reclaim their homeland from the dragon Smaug.", dateOfCreation = DateTime.Today, price = 5, author=thirdAuthor ,genre= firstGenre},
                        new Book(){ Id="8",coverUrl=cover8,title = "The Fellowship of the Ring", description = "The first volume of Tolkien's epic high fantasy series, following the journey of Frodo Baggins and his companions as they seek to destroy the One Ring and defeat the Dark Lord Sauron.", dateOfCreation = DateTime.Today, price = 10, author=thirdAuthor ,genre= secondGenre},
                        new Book(){ Id="9",coverUrl=cover9,title = "The Silmarillion", description = "A collection of mythopoeic works that delve into the mythology and history of Middle-earth, including the creation myth, the deeds of the Valar and Maiar, and the tales of Elves, Men, and Dwarves.", dateOfCreation = DateTime.Today, price = 20, author=thirdAuthor ,genre= thirdGenre}
                    });
                    context.SaveChanges();
                }
                #endregion
